...
|---|---|---|---|---|
| 2026-06-22 | design | open | [notify-subcommand-and-self-flag](./2026-06-22-notify-subcommand-and-self-flag.md) | notify subcommand と --self flag を追加し subscribe 経路を自セッション非同期指示に流用する設計案 |
